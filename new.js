...
console.log(car)
const rental = new Rental(car, ' Doe', '2023-05-01', '2023-05-05');
...
// score if the answer is correct.
 class Question {
  ...
  const question1 = new Question('What is caiptal of Kenya?', ['Nairobi', 'Meru', 'Kitale'], 'Nairobi');
const question2 = new Question('What is the largest county  Kenya?', ['Meru', 'Nairobi', 'Kisii'], 'Mombasa');
